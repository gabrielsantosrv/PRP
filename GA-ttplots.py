...
def genetic_algorithm_solver(prp, population_size, ngen,
    ...
    return fitness_scores, best_chromosome, target_time
...
if __name__ == '__main__':
    ...
    for instance_size in [100]:
        ...
        for ref_cost in [2175.292804, 2619.790834]:
            ...
            df.to_csv('ttplots_uk_{}_configA_{}.csv'.format(instance_size, ref_cost))
            ...
            for i in range(1, 150):
                ...
                fitness_scores, best_chromosome, target_time = genetic_algorithm_solver(prp,
                                                                           ...
                                                                           ngen=ngen,
                                                                           crossover_rate_decay=1,
                                                                           mutation_rate_decay=0.001,
                                                                           speed_mutation_rate=0.23,
                                                                           elitism_rate=0.15,
                                                                           maintain_diversity=False,
                                                                           selection_method=prp.tournament_selection,
                                                                           patience=1000,
            ...
            df = pd.DataFrame(results)
            df.to_csv('ttplots_uk_{}_config4_{}.csv'.format(instance_size, ref_cost))
